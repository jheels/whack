        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4">
            <div className="bg-pixelBackground border-4 border-pixelBorder border-dashed rounded-lg max-w-3xl w-full p-6 space-y-6">
                <div className="space-y-2">
                    <h2 className="text-2xl font-pixel text-pixelText">What advice would you give?</h2>
                    <p className="text-lg font-pixel text-pixelText">Choose your response carefully - your advice will impact {scenario.advisee.name}'s financial future.</p>
                </div>
